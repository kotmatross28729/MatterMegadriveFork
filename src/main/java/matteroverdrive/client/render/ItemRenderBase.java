...
/*
 * Taken from: https://github.com/HbmMods/Hbm-s-Nuclear-Tech-GIT/blob/master/src/main/java/com/hbm/render/item/ItemRenderBase.java
 */
public abstract class ItemRenderBase implements IItemRenderer {
	@Override
	public boolean handleRenderType(ItemStack item, ItemRenderType type) {
		return switch (type) {
			case EQUIPPED, EQUIPPED_FIRST_PERSON, ENTITY, INVENTORY -> true;
			default -> false;
		};
	}
