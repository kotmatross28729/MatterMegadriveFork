...
/*
 * Taken from: https://github.com/HbmMods/Hbm-s-Nuclear-Tech-GIT/blob/master/src/main/java/com/hbm/render/loader/HFRWavefrontObject.java#
 */
public class MO_WavefrontObject implements IModelCustomNamed {
	...
	public MO_WavefrontObject(ResourceLocation resource) throws ModelFormatException {
	...
	public MO_WavefrontObject(ResourceLocation resource, boolean smoothing) throws ModelFormatException {
		this(resource);
		this.smoothing = smoothing;
	}
	
	public MO_WavefrontObject(String filename, InputStream inputStream) throws ModelFormatException {
	...
	public MO_WavefrontObjVBO asVBO() {
		return new MO_WavefrontObjVBO(this);
	}
}
