...
/*
 * Taken from: https://github.com/HbmMods/Hbm-s-Nuclear-Tech-GIT/blob/master/src/main/java/com/hbm/render/loader/WavefrontObjVBO.java
 */
public class MO_WavefrontObjVBO implements IModelCustomNamed {
	class VBOBufferData {
	...
	public MO_WavefrontObjVBO(MO_WavefrontObject obj) {
